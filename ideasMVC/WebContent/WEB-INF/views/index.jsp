...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
			<li class="nav-item"><form action="">Log In<span class="sr-only">(current)</span></form></li>
			<li class="nav-item"><form action="">Create Account<span class="sr-only">(current)</span></form></li>
		</ul>
	</div>
	</nav>
